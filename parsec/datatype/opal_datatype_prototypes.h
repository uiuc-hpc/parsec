...
#ifndef PARSEC_DATATYPE_PROTOTYPES_H_HAS_BEEN_INCLUDED
#define PARSEC_DATATYPE_PROTOTYPES_H_HAS_BEEN_INCLUDED
...
#endif  /* PARSEC_DATATYPE_PROTOTYPES_H_HAS_BEEN_INCLUDED */
