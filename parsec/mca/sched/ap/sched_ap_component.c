 ...
 * Local function
 */
static int sched_ap_component_query(mca_base_module_t **module, int *priority);
 ...
 */
const parsec_sched_base_component_t parsec_sched_ap_component = {
...

    {
        ...
        NULL, /*< No open: sched_ap is always available, no need to check at runtime */
...
{
    return (mca_base_component_t *)&parsec_sched_ap_component;
}

static int sched_ap_component_query(mca_base_module_t **module, int *priority)
{
    /* module type should be: const mca_base_module_t ** */
    void *ptr = (void*)&parsec_sched_ap_module;
    *priority = 12;
